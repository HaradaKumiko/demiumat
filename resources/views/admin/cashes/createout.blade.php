...
@section('content')
    <div class="main-content">
      <section class="section">
        <div class="section-header">
          ...
          <div class="section-header-breadcrumb">
            ...
            <div class="breadcrumb-item"><a href="javascript:void(0);">Tambah Kas Keluar</a></div>
         </div>
        </div>
      ...
      <div class="card">
        ...
        <form action="{{ route('cashs.storeout') }}" method="POST"> 
          @csrf
        <div class="card-body">
            ...
            <tr>
               ...
               <td>
                  <div class='d-inline-flex'>
                     <a href="{{ route('cashs.editout', ['cash' => $cash->id]) }}" class='btn btn-icon icon-left btn-warning btn-sm mr-2'><i class="fas fa-edit"></i>Edit</a>
