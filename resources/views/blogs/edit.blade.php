      ...
      <section class="section">
        <div class="section-header">
          ...
          <div class="section-header-breadcrumb">
            ...
            <div class="breadcrumb-item"><a href="javascript:void(0);">Edit Blog</a></div>
         </div>
        </div>
      ...
      <div class="card">
        ...
        <div class="card-body">
          ...
          <div class="form-group row align-items-center">
            ...
            <div class="col-sm-6 col-md-9">
                <textarea name="content" class="form-control {{ $errors->has('content') ? 'is-invalid' : '' }}">{{ $blog->content }}</textarea>
          ...
          <div class="form-group row align-items-center">
            ...
            <div class="col-sm-6 col-md-9">
              <div class="custom-file">
                <figure>
                    <img src="{{ Storage::url($blog->thumbnail)}}" alt="thumbnail" width="100">
                  </figure>
